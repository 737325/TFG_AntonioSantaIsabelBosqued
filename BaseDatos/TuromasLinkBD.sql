...
CREATE TABLE `campos` (
  ...
  `campo_nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `fk_id_plantilla_idx` (`id_plantilla`),
  CONSTRAINT `fk_id_plantilla` FOREIGN KEY (`id_plantilla`) REFERENCES `plantillas` (`id_plantilla`)
...
-- Dump completed on 2022-09-21  5:40:32
